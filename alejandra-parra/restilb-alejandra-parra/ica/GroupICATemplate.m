...
s1_s1 = {'/home/cristian/Documentos/brain/alejandra-parra/ica/processed_files', '*.img'}; % subject 1 session 1
%%%%%%%%%%%%%%%%%%%%%%% end for Method 2 %%%%%%%%%%%%%%

%% Enter directory to put results of analysis
outputDir = '/home/cristian/Documentos/brain/alejandra-parra/ica/components';
